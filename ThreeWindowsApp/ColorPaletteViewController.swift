...
class ColorPaletteViewController: UIViewController {
    ...
    @IBAction func minButtonPressed(_ sender: UIButton)
    {
        sender.shrink()
        setValueToAllSliders(minValue)
    }
    ...
    {
        sender.shrink()
        setValueToAllSliders(maxValue)
    }
    
    @IBAction func anySliderChanged(_ sender: UIButton)
    {
        updatePaletteColor()
        updateColorLabels()
    }
